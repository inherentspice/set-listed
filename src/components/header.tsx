...
import MyNetwork from "../media/icons/my-network.svg";
import Gigs from "../media/icons/gigs.svg";
import Messaging from "../media/icons/messaging.svg";
import Notifications from "../media/icons/notifications.svg";
import Search from "../media/icons/search.png";
import Services from "../media/icons/services.svg";
