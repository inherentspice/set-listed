...
export default function Header() {
  ...
  return(
    <div className="header flex flex-row w-screen justify-center bg-blue-900">
      <div className="header-cont flex flex-row w-9/12 p-2 justify-between ">
        <div className="header-nav-left flex">
          <div className='header-nav-search flex flex-row gap-3 items-center'>
            <a href="../"><div className="header-cont-logo text-yellow-700 font-bold text-1xl p-2 bg-gray-800 rounded-lg">SL</div></a>
            <div className="header-cont-search flex flex-col bg-white pl-1 pr-6 rounded-2xl items-center gap-2 focus-within:rounded-b-none ">
        ...
        <div className="header-nav-middle flex flex-row">
          <div className="header-nav-btns flex flex-row text-white text-sm text-center gap-4">
            ...
            <a href='/messaging' className="header-nav-btn flex flex-col justify-center fill-white hover:fill-yellow-700 hover:text-yellow-700 hover:bg-white w-20 items-center rounded">
              <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48" className="header-nav-img h-8"><path d="M306 533q17 0 28.5-11.5T346 493q0-17-11.5-28.5T306 453q-17 0-28.5 11.5T266 493q0 17 11.5 28.5T306 533Zm177 0q17 0 28.5-11.5T523 493q0-17-11.5-28.5T483 453q-17 0-28.5 11.5T443 493q0 17 11.5 28.5T483 533Zm170 0q17 0 28.5-11.5T693 493q0-17-11.5-28.5T653 453q-17 0-28.5 11.5T613 493q0 17 11.5 28.5T653 533ZM80 976V236q0-23 18-41.5t42-18.5h680q23 0 41.5 18.5T880 236v520q0 23-18.5 41.5T820 816H240L80 976Zm60-145 75-75h605V236H140v595Zm0-595v595-595Z"/></svg>
              <p className="header-nav-btn-name text-xs">Messaging</p>
            </a>
            ...
            {userId && <a href={`/user/${userId}`} className="header-nav-btn flex flex-col justify-center fill-white hover:fill-yellow-700 hover:text-yellow-700 hover:bg-white w-20 items-center rounded">
              <img className='header-nav-img h-8' src={profile} alt=""/>
              <p className="header-nav-btn-name text-xs">My Page</p>
            </a>}
          ...
          <a href="/login" className="header-nav-btn flex flex-col justify-center fill-white hover:fill-yellow-700 hover:text-yellow-700 hover:bg-white w-20 items-center rounded" onClick={handleLogout}>
            <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48" className="header-nav-img h-8"><path d="M180 936q-24 0-42-18t-18-42V276q0-24 18-42t42-18h291v60H180v600h291v60H180Zm486-185-43-43 102-102H375v-60h348L621 444l43-43 176 176-174 174Z"/></svg>
            <p className="header-nav-btn-name text-xs">Logout</p>
          </a>
          </div>
        </div>
      </div>
