            ...
            <div className="recommendation-card" key={card.id}>
              ...
              <div className="recommendation-card-middle">
                <div className="recommendation-card-info">
                  ...
                  <p className="recommendation-card-performer-type">{card.type}</p>
                  <p className="recommendation-card-performer-tagline">{card.tagline}</p>
                </div>
                <p className="recommendation-card-followers">{card.followers+ " followers"}</p>
              </div>
