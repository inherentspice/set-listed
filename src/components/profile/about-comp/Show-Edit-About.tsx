...
import { handleEditContentChange } from "./Handle-Edit-Content-Change";


export default function ShowEditAbout(props: {about:AboutData, setAbout:any, err: boolean, handleExpandEditAboutToggle: any, setErr: any}) {

  const [content, setContent] = useState<string>(props.about.content);
      ...
      <div className="expanded-profile-overlay">
        ...
        <div className="edit-profile-about-body">
          ...
          <form className="edit-profile-about-form">
            <textarea className="edit-profile-about-text-area" defaultValue={content} rows={10} cols={70} maxLength={2000} onChange={(e) => handleEditContentChange(e, setContent)}></textarea>
            <div className="expanded-profile-overlay-submit">
              <button className="secondary-button" type="submit" onClick={(e) => handleAddAboutEditClick(e, content, props.about.user, props.setAbout, props.handleExpandEditAboutToggle, props.setErr)}>Save</button>              
            </div>
          </form>
