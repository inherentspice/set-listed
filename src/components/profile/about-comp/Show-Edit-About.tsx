...
export default function ShowEditAbout(props: {
  about: AboutData,
      ...
      <div className="expanded-profile-overlay">
        ...
        <div className="edit-profile-about-body">
          ...
          <form className="edit-profile-about-form">
            <textarea className="edit-profile-about-text-area" defaultValue={content} rows={10} cols={70} maxLength={2000} onChange={(e) => setContent(e.target.value)}></textarea>
