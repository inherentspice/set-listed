  ...
  return(
    <div className="profile-about-cont comp">
      ...
      <div className="profile-about-text-cont">
        ...
        {expandedEditAbout && <ShowEditAbout about={about} setAbout={setAbout} content={content} setContent={setContent} err={err} handleExpandEditAboutToggle={handleExpandEditAboutToggle} setErr={setErr}/>}
      </div>
    </div>
  );
}
