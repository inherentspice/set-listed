...
export const FakeUserData = {
  ...
  activity: [{id: 7, date: new Date("January 1, 2023"), description: "I truly believe that I am the Bill Burr of the improv stage", title: "10 Reasons I am Bill Burr", url: "bendover.net", read: "2 min", img: BillBurr, likes: 1, dislikes: 1035}, {id: 8, date: new Date("December 25, 2022"), description: "Steve Harvey's suits are fake and I have the proof they all zip up in the back.", title: "Steve Harvey the Liar", url: "bendover.net", read: "24 min", img: SteveHarvey, likes: 2560, dislikes: 1}]
};
