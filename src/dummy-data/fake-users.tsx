...
import IanBadenhurstPic from "../media/profile/ian-badenhurst-profile-pic.png";

export const FakeUserData = [{
  username: "georgecastles",
...
{
  username: "ianbadenhurst",
  userFirstName: "Ian",
  userLastName: "Badenhurst",
  city: "Cape Town",
  country: "South Africa",
  id: 6789,
  category: "Comedy",
  subCategory: "Standup Comedian",
  userProfilePicture: IanBadenhurstPic,
  userBackgroundPicture: GeorgeCastlesBG,
  userTagline: "Lifes a chump's game",
  userProfileViews: 2,
  userPostImpressions: 69,
  userSearchAppearances: 500,
  userFollwers: 1234,
